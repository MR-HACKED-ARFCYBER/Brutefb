# /bin/python !
# https://github.com/MR-HACKED-ARFCYBER/
...
\033[1;91ARFCyber\033[1;97m>>\033[1;92m ''')
...
\033[1;91m<═══\033[1;41m\033[1;97m Created by Mr-ARFCyber \033[;0m\033[1;91m═══>\033[1;92m""")
...
\033[1;91m[\033[1;97m?\033[1;91m]\033[1;92m Features Of ARFCyber:
...
\033[1;97m➤ \033[1;92mTool ARFCyber is created by ARFCyber
\033[1;92m""")
...
\033[1;97m[\033[1;91m??\033[1;97m] \033[1;91mARFCyber>> \033[1;92m"""
...
# main script start
os.system("xdg-open https://youtube.com/@wong03")
time.sleep(5)
...
while True:
	...
	if menu == '01' or menu == '1':
		...
		while True:
			...
			if pas == '01' or pas == '1':
				print()
				os.system("instagram-py --username " + usr + " --password-list password.txt")
		...
		print(banr)
		print()
		print("\033[1;91m[\033[;1;97m~\033[1;91m] \033[1;92mThanks for using my tool 'ARFCyber'. You can follow me on various social media site. Link and options are given down below, So select here options where you want to follow me ")
		print()
		print()
		while True:
			fol = input(soc)
			if fol == '1' or fol == '01':
				...
				time.sleep(1)
				os.system("xdg-open https://t.me/m_arif_nugroho")
